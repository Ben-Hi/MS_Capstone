...
output_dir = "/home/hillenb/Desktop/MS_Capstone/My_M2Former_Detectron2/models/overfit_testing"
...
cfg.MODEL.SEM_SEG_HEAD.NUM_CLASSES = len(settings.THING_CLASSES)

cfg.DATASETS.TRAIN = (settings.WHOLE_DATASET_NAME,)
cfg.DATASETS.TEST = ()
...
evaluator = COCOEvaluator(settings.WHOLE_DATASET_NAME, output_dir=cfg.OUTPUT_DIR)
